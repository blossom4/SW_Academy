...
const res = languages.filter(function(lang) {
...
const res = scores.reduce(function(acc, score) {
...
const res = accounts.find(function(account) {
...
const res = requests.some(function(request) {
...
const res = users.every(function(user) {
